...
#filename = '/media/data/ytye/influenza/lda_model.sav'
...
#plt.xlim(-5, 6)
#plt.ylim(-5, 5)
#plt.savefig("/media/data/ytye/influenza/allfeature_LDA_avian_sporadic_persistent.pdf")
...
#Fig. 5c
#G1-G14
data = pd.read_csv('/media/data/ytye/influenza/H5_202204_202309_features_predict_seqname_label_genotype.csv', sep=',', header=None)
...
#cattle 
data = pd.read_csv('/media/data/ytye/influenza/cow_202401To06/northAmer/feature_exact_predict_host_NorthAmerica_2334b.csv', sep=',', header=None)
...
#HuH3N8
data = pd.read_csv('/media/data/ytye/influenza/16weight/HuH3N8.feature_predict.csv', sep=',', header=None)
...
#data = pd.read_csv('/media/data/ytye/influenza/earliest_Sw2_features_seqname_predict.csv', sep=',', header=None)
...
#)
#data = pd.read_csv('/media/data/ytye/Sw1985/EA/Ea_feature.csv', sep=',', header=None)
#array3 = data.to_numpy()
#X3 = array3[:,2:42]
...
#plt.savefig("/media/data/ytye/EA/allfeature_LDA_avianPDFBySVM_persistentPDFBySVM_Sw2_ancestral.pdf")

plt.legend(ncol=8, loc = "best")
plt.xlim(-5, 6)
plt.ylim(-5, 5)
plt.savefig("/media/data/ytye/influenza/allfeature_LDA_avian_sporadic_persistent_genotype_cattle_2321c_huH3N8.pdf")